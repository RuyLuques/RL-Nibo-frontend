    ...
    <main className="p-5">
      <div className="container mx-auto mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
        <div className="bg-white p-4">
          <h1 className="text-4xl md:text-6xl lg:text-8xl text-3xl md:text-5xl lg:text-7xl text-indigo-800 py-5">Bem-vindo</h1>
          <h2 className="text-3xl md:text-5xl lg:text-5xl text-2xl md:text-4xl lg:text-6xl text-indigo-600">Eu sou Ana Ruy</h2>
