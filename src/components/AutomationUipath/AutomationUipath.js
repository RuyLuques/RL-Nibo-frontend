...
import { fetchUipathProjects } from '../../services/api';

function AutomationUipath() {
  ...
  useEffect(() => {
    fetchUipathProjects() 
      ...
      .catch((error) => {
        console.error('Error fetching Uipath projects:', error);
      });
  }, []);
  ...
  return (
    <div className="bg-white py-10 rounded-md">
      <div className="container mx-auto h-full">
        <h1 className="text-4xl font-bold text-orange-600 text-center mb-8">Uipath</h1>
...
export default AutomationUipath;
